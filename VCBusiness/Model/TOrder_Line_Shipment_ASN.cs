...
namespace VCBusiness.Model
{
     ...
     public class TOrder_Line_Shipment_ASN : Entity 
     {
          ...
          public ReturnValue getOrderLineShipmentASNByOrderID(int orderId, int release)
          {
              string Usp_SQL = String.Format(WComm.SqlDefine.getSQL("getOrderLineShipmentASNByOrderID"), orderId, release);
